...
import {BiAnalyse, BiDetail, BiBook} from 'react-icons/bi';
...
// font-size: clamp(60px, 8.5vw, 5rem);
// font-weight: bold;
// `;
...
align-items: center;
`;
export const WorksIcon1 = styled(BiAnalyse)`
color: #333;
font-size: 8rem;
`;
...
font-size: 6rem;
`;
export const WorksIcon3 = styled(BiBook)`
color: #333;
font-size: 6rem;
`;
